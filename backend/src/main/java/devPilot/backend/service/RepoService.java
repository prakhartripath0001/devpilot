...
public class RepoService {
    ...
    public List<RepositoryResponse> syncAndListRepos(UUID userId) {
        ...
        for (Map<String, Object> remote : remoteRepos) {
            ...
            // Converting to String since Repository.java defines githubRepoId as String
            repo.setGithubRepoId(String.valueOf(githubRepoId));
            ...
            // repo.setPrivate(Boolean.TRUE.equals(remote.get("private"))); // Not in
            // Repository.java
    ...
    public IndexStatusResponse status(UUID repoId, UUID userId) {
        ...
        return new IndexStatusResponse(
                ...
                repo.getIndexStatus(),
                repo.getFileTotal(),
                repo.getTotalProcessed(),
                0, // repo.getChunkCount() - not in Repository.java
                repo.getIndexedAt(),
    ...
    public RepositoryResponse toResponse(Repository repo) {
        return new RepositoryResponse(
                ...
                repo.getName(),
                repo.getFullName(),
                false, // repo.isPrivate() - not in Repository.java
